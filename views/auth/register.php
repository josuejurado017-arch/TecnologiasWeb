        ...
        <div class="card">
            ...
            <form method="post" action="<?= e(app_url('register.php')) ?>">
                ...
                <div class="form-grid">
                    ...
                    <div><label for="semestre">Semestre</label><input id="semestre" name="semestre" type="number" min="1" max="20" required value="<?= e($data['semestre']) ?>"></div>
                    <div><label for="registro_universitario">Registro Universitario (RU)</label><input id="registro_universitario" name="registro_universitario" type="text" maxlength="30" pattern="[A-Za-z0-9-]{1,30}" title="Use solo letras, números y guiones." value="<?= e($data['registro_universitario']) ?>"></div>
