...
require_once dirname(__DIR__) . '/models/TutorMateria.php';
require_once dirname(__DIR__) . '/models/DisponibilidadTutor.php';
require_once dirname(__DIR__) . '/models/Tutoria.php';
require_once dirname(__DIR__) . '/models/SolicitudHorarioEspecial.php';
require_once dirname(__DIR__) . '/models/EvaluacionTutoria.php';
require_once dirname(__DIR__) . '/models/RegistroAcceso.php';
require_once dirname(__DIR__) . '/models/Permiso.php';
require_once dirname(__DIR__) . '/models/HistorialTutoria.php';
require_once dirname(__DIR__) . '/models/AsistenciaTutoria.php';
require_once dirname(__DIR__) . '/models/Notificacion.php';
require_once dirname(__DIR__) . '/models/ReporteTutoria.php';
...
require_once dirname(__DIR__) . '/controller/TutorMateriasController.php';
require_once dirname(__DIR__) . '/controller/DisponibilidadController.php';
require_once dirname(__DIR__) . '/controller/TutoriasController.php';
require_once dirname(__DIR__) . '/controller/SolicitudesEspecialesController.php';
require_once dirname(__DIR__) . '/controller/EvaluacionesController.php';
require_once dirname(__DIR__) . '/controller/AccesosController.php';
require_once dirname(__DIR__) . '/controller/ReportesController.php';
require_once dirname(__DIR__) . '/controller/PermisosController.php';
